    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-12 mx-auto bg-white p-4">
                        ...
                        <h2 class="text-lg"><strong>PAGO SEGURO</strong></h2>

                        <p class="p-2 mb-2">Welcome to {{ config('app.name') }}!</p>

                        <p class="p-2 mb-2">These terms and conditions outline the rules and regulations for the
                            use of
                            {{ config('app.name') }}'s Website, located at {{ config('app.url') }}.</p>

                        <p class="p-2 mb-2">By accessing this website we assume you accept these terms and
                            conditions.
                            Do not
                            continue to use {{ config('app.url') }} if you do not agree to take all of the terms and
                            conditions stated
                            on this page.</p>

                        <p class="p-2 mb-2">The following terminology applies to these Terms and Conditions,
                            Privacy
                            Statement and
                        ...
                        <p class="p-2 mb-2">We employ the use of cookies. By accessing {{ config('app.url') }},
                            you agreed
                            to use
                            cookies in agreement with the {{ config('app.name') }}'s Privacy Policy. </p>

                        <p class="p-2 mb-2">Most interactive websites use cookies to let us retrieve the user’s
                            details
                            for each
                        ...
                        <p class="p-2 mb-2">Unless otherwise stated, {{ config('app.name') }} and/or its
                            licensors own the
                            intellectual property rights for all material on {{ config('app.url') }}. All intellectual
                            property rights
                            are reserved. You may access this from {{ config('app.url') }} for your own personal use
                            subjected to
                        ...
                        <p class="p-2 mb-2">This Agreement shall begin on the date hereof. Our Terms and
                            Conditions were
                            created
                        ...
                        <p class="p-2 mb-2">Parts of this website offer an opportunity for users to post and
                            exchange
                            opinions and
                            information in certain areas of the website. {{ config('app.name') }} does not filter,
                            edit,
                            publish or
                            review Comments prior to their presence on the website. Comments do not reflect the views
                            and opinions
                            of {{ config('app.name') }},its agents and/or affiliates. Comments reflect the views and
                            opinions of the
                            person who post their views and opinions. To the extent permitted by applicable laws,
                            {{ config('app.name') }} shall not be liable for the Comments or for any liability, damages
                            or
                            expenses
                        ...
                        <p class="p-2 mb-2">{{ config('app.name') }} reserves the right to monitor all Comments
                            and to
                            remove any
                        ...
                        <p class="p-2 mb-2">You hereby grant {{ config('app.name') }} a non-exclusive license to
                            use,
                            reproduce, edit
                        ...
                        <p class="p-2 mb-2">The following organizations may link to our Website without prior
                            written
                            approval:</p>
                        ...
                        <p class="p-2 mb-2">These organizations may link to our home page, to publications or to
                            other
                            Website
                        ...
                        <p class="p-2 mb-2">We may consider and approve other link requests from the following
                            types of
                            organizations:</p>
                        ...
                        <p class="p-2 mb-2">We will approve link requests from these organizations if we decide
                            that:
                            (a) the link
                            ...
                            hyperlink
                            compensates the absence of {{ config('app.name') }}; and (d) the link is in the context of
                            general
                            resource information.</p>

                        <p class="p-2 mb-2">These organizations may link to our home page so long as the link: (a)
                            is
                            not in any way
                        ...
                        <p class="p-2 mb-2">If you are one of the organizations listed in paragraph 2 above and
                            are
                            interested in
                            ...
                            site, a list
                            of any URLs from which you intend to link to our Website, and a list of the URLs on our site
                            to which
                        ...
                        <p class="p-2 mb-2">No use of {{ config('app.name') }}'s logo or other artwork will be
                            allowed for
                            linking
                        ...
                        <p class="p-2 mb-2">Without prior approval and written permission, you may not create
                            frames
                            around our
                        ...
                        <p class="p-2 mb-2">We shall not be hold responsible for any content that appears on your
                            Website. You agree
                            to protect and defend us against all claims that is rising on your Website. No link(s)
                            should appear on
                            any Website that may be interpreted as libelous, obscene or criminal, or which infringes,
                            otherwise
                        ...
                        <p class="p-2 mb-2">We reserve the right to request that you remove all links or any
                            particular
                            link to our
                        ...
                        <p class="p-2 mb-2">If you find any link on our Website that is offensive for any reason,
                            you
                            are free to
                        ...
                        <p class="p-2 mb-2">We do not ensure that the information on this website is correct, we
                            do not
                            warrant its
                        ...
                        <p class="p-2 mb-2">To the maximum extent permitted by applicable law, we exclude all
                            representations,
                        ...
                        <p class="p-2 mb-2">The limitations and prohibitions of liability set in this Section and
                            elsewhere in this
                        ...
                        <p class="p-2 mb-2">As long as the website and the information and services on the website
                            are
                            provided free
