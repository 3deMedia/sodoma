            ...
            @else
                ...
                @endif
                    ...
                    <div>
                        ...
                        <div class="row mt-5">
                            <div class="pb-4">
                                <h3 class="fs-3 fw-bold text-333 border-bottom border-mcolor w-100 pb-3" for="logo">
                                    Logotipo</h3>
                                <input type="file" name="logo" id="logo" class="w-100">
                            </div>
                            <h3 class="fs-3 fw-bold text-333 border-bottom border-mcolor w-100 mt-5 pb-3">Imagen de
                                portada</h3>
                                        ...
                                        <select required class="js-example-basic-single w-100 " name="country_id"
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}" {{  old('country_id') == $country->id ? 'selected' : '' }}>
                                                    {{ __("geodata.countries.$country->name") }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </label>
                            ...
                            <div class="col-12  mt-5">
                                <div class="w-100 p-2 mb-2">
                                    <label for="" class="w-100">
                                        ...
                                        <input required type="text" name="profile_address" id="profile_address"
                                            class="w-100" value="{{  old('address') }}" />
                                    </label>
                                </div>
                            </div>
                        </div>
