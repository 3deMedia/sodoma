...
<div class="botsficha botwhats"><a href="https://api.whatsapp.com/send?phone=34{{ $profile->phone }}&text=Hola">{{ __('forms.profile.attended') }}<br /><img src="{{ asset('images/whatsapp.png') }}" /> Whatsapp</a></div></div></div>
