<x-admin-layout>
    ...
    <div class="container pt-5">
        ...
        <div class="row">
            <div class="col-12">
                <h1 class="text-info">Actualizar post </h1>
                <form action="{{ route('posts.update',$post->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                        ...
                        <div class="form-group w-25">
                            <label for="title" class="block label">@lang('Slug')</label>
                        ...
                        <div class="form-group w-25">
                            <label for="active">
                                <input type="checkbox" name="active" @if($post->active) checked @endif id="active"> Visible
                            </label>
