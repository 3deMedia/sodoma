    ...
    FUNDING_SOURCES.forEach(function (fundingSource) {
      ...
      var button = paypal.Buttons({
        ...
        createOrder: function () {
          var _createOrder = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(data, actions) {
            ...
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return $('input[name=product]:checked').val();

                  case 2:
                    product = _context.sent;
                    _context.next = 5;
                    return axios.post('/checkout/api/paypal/order/create', {
                      product: product
                    }).then(function (resp) {
        ...
        onApprove: function () {
          var _onApprove = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(data, actions) {
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return axios.post('/payment/capture-paypal-transaction', {
                      order: data
                    }).then(function (captureData) {
                      // captura el error de pago
                      if (captureData.data.error === 'INSTRUMENT_DECLINED') {
